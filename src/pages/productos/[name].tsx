  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`${process.env.NEXT_PUBLIC_BASE_URL}productos/${product.name}`} />
        {/* Twitter */}
            ...
            <table className="table w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                  ...
                  {Object.keys(product.chemical_composition ?? {}).map((item) => (
                    <th scope="col" className="px-6 py-3">
                      {item}
                    </th>
                  ))}
              ...
              <tbody>
                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                  ...
                  {Object.values(product.chemical_composition ?? {}).map((item) => (
                    <td scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                      {item}
                    </td>
                  ))}
