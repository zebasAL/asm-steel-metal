        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <div className="flex sm:justify-center sm:mt-0">
              <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/profile.php?id=61551922603639" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/asm_steel_metal/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/company/100098388/admin/feed/posts/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/channel/UC32yDGNT_nu9bEQQ-wC1Fug" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <a target="_blank" rel="noopener noreferrer" className="hover:underline" href="https://www.google.com/search?q=+asm+steel+metal+querearo&sca_esv=593226457&rlz=1C1NHXL_esMX1067MX1067&sxsrf=AM9HkKkQwpmxrSbkLdyqSkDflYMVnoFhxw%3A1703319904627&ei=YJmGZYn4Jb_bkPIP6sOwwA8&ved=0ahUKEwiJqOqOkaWDAxW_LUQIHeohDPgQ4dUDCBA&uact=5&oq=+asm+steel+metal+querearo&gs_lp=Egxnd3Mtd2l6LXNlcnAaAhgBIhkgYXNtIHN0ZWVsIG1ldGFsIHF1ZXJlYXJvMgoQIxiwAhgnGIsDSKMCUABYAHAAeACQAQCYAX-gAX-qAQMwLjG4AQPIAQD4AQHiAwQYACBB4gMFEgExIECIBgE&sclient=gws-wiz-serp" title="google">
                    Queretaro
                  </a>
                </li>
                <li>
                  <a target="_blank" rel="noopener noreferrer" className="hover:underline" title="google" href="https://www.google.com/search?q=asm+steel+metal+tlanepantla&rlz=1C1NHXL_esMX1067MX1067&oq=asm+steel+metal+tlanepantla&gs_lcrp=EgZjaHJvbWUyBggAEEUYOdIBCDk3NzBqMGo3qAIAsAIA&sourceid=chrome&ie=UTF-8"
                  >
                    Tlalnepantla
                  </a>
                </li>
